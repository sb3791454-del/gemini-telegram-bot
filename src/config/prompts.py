...
WELCOME_TEXT = (
    ...
    "/memory - یادداشت اور سٹیٹ سٹیٹس چیک کریں\n"
...
HELP_TEXT = (
    ...
    "4. *صارف کی شناخت (User ID):* /id لکھ کر اپنا Telegram Numeric User ID دیکھ سکتے ہیں۔\n"
    "5. *میموری سٹیٹس:* /memory لکھ کر اسسٹنٹ کی میموری کا سٹیٹس دیکھ سکتے ہیں۔\n"
)
